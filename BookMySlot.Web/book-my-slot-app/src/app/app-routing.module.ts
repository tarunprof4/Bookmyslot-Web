...
import { LastSharedSlotResolverService } from './services/resolvers/last-shared-slot-resolver.service';
...
const routes: Routes = [
  ...
  { path: RoutingConstants.ShareSlot, component: ShareSlotComponent, resolve: { resolvedLastSharedSlot: LastSharedSlotResolverService }, canActivate: [AuthGuard] },
